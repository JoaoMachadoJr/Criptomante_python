...
var D3Streamgraph = function() {
    ...
    var _streamgraph = function() {
        ...
        if(element) {
            ...
            // var colorrange = ['#d24d3d', '#f5a275', '#ffe2aa', '#e6f5fe', '#99c7eb', '#3b89c9'];
            var colorrange = ['#225ea8', '#1e90c0', '#40b6c4', '#7fcdbb', '#c7e8b4', '#edf8b1'];
            // var colorrange = ['#09519c', '#2270b5', '#4192c5', '#6baed6', '#9dcae1', '#c6dbef'];
            // var colorrange = ['#23873e', '#2f9446', '#3ca050', '#48ac5c', '#58b868', '#68c475'];
            // var colorrange = ['#2ec7c9','#b6a2de','#5ab1ef','#ffb980','#d87a80','#8d98b3'];
            // var colorrange = ['#37a2da','#32c5e9','#9fe6b8','#ffdb5c','#ff9f7f','#fb7293'];
            // var colorrange = ['#f48b84','#a1d1cb','#ffe0ae','#ff6f69','#43ada5','#81a2bd'];
            // var colorrange = ['#494c79','#515483','#5e6398','#6b73b0','#7e87c7','#8c95d4'];
